...
RESOURCEGROUP="cf-civiclab-perpectiva"
LOCATION="francecentral"
PLANNAME="ASP-cfciviclabperpectiva-892e"
PLANSKU="B1"
SITENAME="perspectiva"
RUNTIME="PYTHON|3.11"
...
az webapp config set --resource-group $RESOURCEGROUP --name $SITENAME --startup-file "python -m ./src/app.py"